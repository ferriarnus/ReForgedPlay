...
//$$         builder.setWellBehaved(true);
        //#if MC>=10809
        //$$ builder.begin(net.minecraft.client.render.VertexFormat.DrawMode.QUADS, VertexFormats.POSITION_COLOR_TEXTURE_LIGHT_NORMAL);
        //#else
...
//$$             int color = stack != null && quad.hasColor()
                    //#if MC>=10904
                    //$$ ? ((ItemRendererAccessor) renderItem).getItemColors().getColor(stack, quad.getColorIndex()) | 0xff000000
                    //#else
