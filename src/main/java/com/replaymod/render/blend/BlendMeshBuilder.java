        ...
        //#endif
{
    ...
    public static DMesh addBufferToMesh(
        ...
        for (VertexFormatElement element : getElements(vertexFormat)) {
            ...
            //$$ elementOffset += element.getByteLength();
            //#else
            //#if MC>=10809
            ...
            switch (element.getType()) {
                case POSITION:
                    //#if MC>=11400
                    if (element.getDataType() != VertexFormatElement.DataType.FLOAT) {
                    //#else
                ...
                case COLOR:
                    //#if MC>=11400
                    if (element.getDataType() != VertexFormatElement.DataType.UBYTE) {
                    //#else
                    ...
                    break;
                case UV:
                    if (element.getTextureIndex() != 0) break;
                    //#if MC>=11400
                    if (element.getDataType() != VertexFormatElement.DataType.FLOAT) {
                    //#else
                    //$$ if (element.getType() != VertexFormatElement.EnumType.UBYTE) {
